...
class LlmResponseParser:
    ...
    def ExtractProductName(
      ...
      return cast(types.Product, parsed)
    ...
    def ExtractProductReviewLinks(
      ...
      return cast(types.Reviews, parsed)
...
class LlmStreamParser:
    ...
    def ExtractProductName(
      ...
      return cast(partial_types.Product, parsed)
    
    def ExtractProductReviewLinks(
        self,
        llm_response: str,
        baml_options: BamlCallOptions = {},
    ) -> partial_types.Reviews:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return cast(partial_types.Reviews, parsed)
