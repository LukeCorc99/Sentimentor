...
class BamlSyncClient:
    ...
    def ExtractProductName(
      ...
      return cast(types.Product, raw.cast_to(types, types, partial_types, False))
    
    def ExtractProductReviewLinks(
        self,
      ...
      return cast(types.Reviews, raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def ExtractProductName(
        ...
        names: List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.Product, types.Product]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[partial_types.Product, types.Product](
        raw,
        lambda x: cast(partial_types.Product, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.Product, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
    ...
    def ExtractProductReviewLinks(
        ...
        name: str,links: List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.Reviews, types.Reviews]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[partial_types.Reviews, types.Reviews](
        raw,
        lambda x: cast(partial_types.Reviews, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.Reviews, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
