...
class CameraSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if "pcmag.com" in response.url:
            yield from self.parseCamReviews(
